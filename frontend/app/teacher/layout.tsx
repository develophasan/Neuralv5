    ...
    <NotificationProvider userId={session?.user?.id}>
      <div className="flex h-screen w-full flex-col md:flex-row bg-stone-50/30 overflow-hidden">
        ...
        <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
          <SheetContent side="left" className="w-[280px] p-0 border-r-0 z-[150] [&>button]:hidden">
            <div className="h-full flex flex-col p-5 pt-6 pb-20 md:pb-4">
        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden">
          ...
          {/* Scrollable Content */}
          <main className="flex-1 overflow-auto p-4 md:p-8 pb-20 md:pb-8 relative scroll-smooth focus:scroll-auto">
            {children}
          </main>
        </div>
